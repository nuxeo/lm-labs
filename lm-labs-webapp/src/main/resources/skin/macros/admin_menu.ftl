<#macro adminMenu item basePath="${This.path}">
	<div class="container">
		<ul class="pills">
		    ...
		    <li <#if item=="theme">class="active"</#if>><a href="${basePath}/@theme/${site.themeManager.theme.name}">${Context.getMessage('label.labssite.admin.tabs.theme')} (${site.themeManager.theme.name})</a></li>
