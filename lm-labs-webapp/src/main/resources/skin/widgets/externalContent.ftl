...
<div id="${id}" >
	...
	<div class="external-content-error" style="display:none;" >
		<div class="alert alert-block alert-error no-fade" >
			<h4 class="alert-heading"><i class="icon-warning-sign" style="font-size: 48px;" ></i>Impossible d'afficher ce fragment</h4>
			<ul class="supplychain-unstyled-ul" >
			<li>Soit le fragment exposé ne provient pas d'une colonne de type "texte enrichi" d'un site de l'usine à sites,</li>
			<li>Soit vous n'avez pas le droit d'accéder au fragment exposé.</li>
			</ul>
