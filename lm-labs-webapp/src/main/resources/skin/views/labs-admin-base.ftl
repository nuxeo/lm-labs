<@extends src="/views/labs-common-base.ftl">
  ...
  <@block name="css">
    <@superBlock/>
        ...
        <link rel="stylesheet" href="${Context.modulePath}/${mySite.URL}/@currenttheme/rendercss-${mySite.themeManager.getTheme(Session).document.dublincore.modified?string("yyyyMMddHHmmss")}?withoutaddedstyle=true" />
  </@block>
