...
<a href="#" onclick="javascript:openAssets('${Context.modulePath}/${Common.siteDoc(Document).getSite(Context.coreSession).URL}/@assets?callFunction=setCallFunction&calledRef=${cptProperties}')">Associer un média</a>
