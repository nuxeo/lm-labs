<input class="input" type="text" class="small" name="quizBackgroundColorEdit${cptProperties}" value="${property.value}" onchange="jQuery('#valueProperty${cptProperties}').val(this.value); " />
