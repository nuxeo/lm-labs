...
<#if Document.type != "Site" && Common.siteDoc(Document).getSite().getHomePageRef() == Document.id >
...
<#else>
    ...
    <#if Common.siteDoc(Document).getSite().getHomePageRef() == Document.id || Document.type == "Site" >
