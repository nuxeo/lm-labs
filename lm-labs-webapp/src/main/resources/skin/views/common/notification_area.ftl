...
<#if Document.type != "Site" && Common.siteDoc(Document).site.indexDocument.id == Document.id >
...
<#else>
    ...
    <#if Common.siteDoc(Document).site.indexDocument.id == Document.id || Document.type == "Site" >
