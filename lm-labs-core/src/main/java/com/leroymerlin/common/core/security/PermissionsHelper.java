...
public class PermissionsHelper {
    ...
    public void grantPermission(final DocumentModel doc,
        ...
        grantPermission(doc, permission, id, override, doc.getCoreSession());
    }
    /**
     *
     * @param doc
    ...
    public static boolean currentUserHasOtherEverythingRightThan(
        ...
        return currentUserHasOtherEverythingRightThan(doc, excludedId, doc.getCoreSession());
    }
    /**
     *
     * @param doc
    ...
    private void removeLowerPermissions(final DocumentModel doc,
        ...
        removeLowerPermissions(doc, permission, id, doc.getCoreSession());
    }
    /**
     *
     * @param space
